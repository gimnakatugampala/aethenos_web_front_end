...
const courseStructure = () => {
  ...
  <Row>
    ...
    <Card className="py-2 my-2"> 
       ...
       <Typography.Title className='p-1' level={4}>
     ...
     <div className='pricing-header'>
      ...
      <Typography.Title className='p-1' level={4}>
       ...
       <Typography.Title className='p-1' level={5}>
       <b>Start with your goals.</b>
       </Typography.Title>
       <p>Setting goals for what learners will accomplish in your course (also known as learning objectives) at the beginning will help you determine what content to include in your course and how you will teach the content to help your learners achieve the goals.</p>

       <Typography.Title className='p-1' level={5}>
       <b>Create an outline.</b>
       </Typography.Title>
       ...
       <Typography.Title className='p-1' level={5}>
       <b>Introduce yourself and create momentum.</b>
       </Typography.Title>
       ...
       <Typography.Title className='p-1' level={5}>
       <b>Sections have a clear learning objective.</b>
       </Typography.Title>
       ...
       <Typography.Title className='p-1' level={5}>
       <b>Lectures cover one concept.</b>
       </Typography.Title>
       ...
       <Typography.Title className='p-1' level={5}>
       <b>Mix and match your lecture types.</b>
       </Typography.Title>
       ...
       <Typography.Title className='p-1' level={5}>
       <b>Practice activities create hands-on learning.</b>
       </Typography.Title>
