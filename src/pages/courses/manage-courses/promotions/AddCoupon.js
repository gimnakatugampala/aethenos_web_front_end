...
// Enter Global Price
  ...
  const handleChangeGlobalPriceChile = (e) => {
    ...
    if(numberOnlyRegex.test(e.target.value)){
      ...
      setChileDiscountPercent(((Number.parseFloat(e.target.value).toFixed(2) / Number.parseFloat(ChileListPrice).toFixed(2)) * 100).toFixed(2))
  ...
  const handleChangeGlobalPriceEU = (e) => {
    ...
    if(numberOnlyRegex.test(e.target.value)){
      ...
      setEUDiscountPercent(((Number.parseFloat(e.target.value).toFixed(2) / Number.parseFloat(EUListPrice).toFixed(2)) * 100).toFixed(2))
  ...
  const handleChangeGlobalPriceJapan = (e) => {
    ...
    if(Number.parseFloat(JapanListPrice) < Number.parseFloat(e.target.value)){
      return
    }
  ...
  const [RussiaminValue, setRussiaminValue] = useState("")
    ...
    const handleChangeGlobalPriceRussia = (e) => {
      ...
      if(numberOnlyRegex.test(e.target.value)){
        ...
        setRussiaDiscountPercent(((Number.parseFloat(e.target.value).toFixed(2) / Number.parseFloat(RussiaListPrice).toFixed(2)) * 100).toFixed(2))
  ...
  const [ThailandminValue, setThailandminValue] = useState("")
    ...
    const handleChangeGlobalPriceThailand = (e) => {
      ...
      if(numberOnlyRegex.test(e.target.value)){
        ...
        setThailandDiscountPercent(((Number.parseFloat(e.target.value).toFixed(2) / Number.parseFloat(ThailandListPrice).toFixed(2)) * 100).toFixed(2))
  ...
  const [SAminValue, setSAminValue] = useState("")
    ...
    const handleChangeGlobalPriceSA = (e) => {
      ...
      if(numberOnlyRegex.test(e.target.value)){
        ...
        setSADiscountPercent(((Number.parseFloat(e.target.value).toFixed(2) / Number.parseFloat(SAListPrice).toFixed(2)) * 100).toFixed(2))
